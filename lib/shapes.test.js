...
//tests for triangle, circle, and square to see if they display each shape with given parameter
describe('Triangle',() => {
...
describe('Square', () => {
    it('should display a yellow square', () => {
